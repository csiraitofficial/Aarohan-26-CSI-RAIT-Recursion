...
export default function MedicinePricePage() {
  ...
  const handleSearch = async (query: string) => {
    ...
    try {
      ...
      const response = await fetch(MEDICINE_ENDPOINTS.search(query), {
        headers: {
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Find the best prices across multiple pharmacies
                </p>
              </div>
            </div>
          ...
          {!results && !isLoading && !error && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Enter a medicine name above to compare prices across different
                pharmacies and find the best deals
              </p>
            </div>
          )}
        </div>
