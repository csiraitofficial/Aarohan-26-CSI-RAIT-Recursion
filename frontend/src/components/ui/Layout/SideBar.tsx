...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  const navigateWithUser = (pathBuilder: (uid: string) => string) => {
    if (!user?.uid) {
      toast.error("Session expired. Please sign in again.");
      navigate("/auth");
      return;
    }
    navigate(pathBuilder(user.uid));
  };
      ...
      <nav className="space-y-2 flex-1">
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/userdashboard/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/nearby-services/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/healthrecords/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/appointments/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/medichat/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/reminder/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/medicineprice/${uid}`);
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/premium-predictor/${uid}`);
          }}
        >
        ...
        <Button
          variant={activeTab === "Govt Insurance Plans" ? "default" : "ghost"}
          className={getButtonClass("Govt Insurance Plans")}
          onClick={() => {
            setActiveTab("Govt Insurance Plans");
            navigateWithUser((uid) => `/govt-plans/${uid}`);
          }}
        >
          <img src={ashokaLogo} alt="Govt Insurance Plans" className="mr-2 h-4 w-4 object-contain" />
          Govt Insurance Plans
        </Button>
      </nav>
      ...
      <div className="space-y-2 pt-4 border-t border-gray-200">
        <Button
          ...
          onClick={() => {
            ...
            navigateWithUser((uid) => `/user-profile/${uid}`);
          }}
        >
