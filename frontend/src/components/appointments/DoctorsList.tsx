...
const getSpecialty = (doctor: Doctor) =>
  doctor?.nexhealth_specialty || "General Medicine";

export default function DoctorsList({ doctors, onSelectDoctor, errorMessage }: DoctorsListProps) {
  ...
  const specialties = useMemo(() => {
    const uniqueSpecialties = new Set(
      doctors.map((doctor) => getSpecialty(doctor)),
    );
